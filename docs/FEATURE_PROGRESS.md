...
家中至2300抵達、雙人合作、第三同伴、fixed ATB、裝備v8及原故事流程全部保留。Z不是完整動畫／音訊／成長／後段章節完成；招牌淡化也不等於所有屋牆遮擋或移動舒適性已解決。
...
程式與完整logs已存指定Drive，最新包1ZrJs8QqmUbOmJO-Do0465d1wtV7FrXKo，詳細hash／parent見DELIVERY_INDEX。
