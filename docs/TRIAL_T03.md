...
The legacy courtroom policy is preserved for untracked v5/v6 history. The 0.8.1 batch adds actual fair conduct, conditional witnesses/questions and both verdicts under versioned fair-witness-v1; see FAIR_WITNESSES.md. No precise hidden SNES juror bytecode, untouched-cat RNG or patched-ROM behavior is certified. Complete topology and fine choreography remain open. Three days use explicit rest transitions rather than the original event clock. The full jail layout, hidden treasures, complete boss statistics/moves, cutscene blocking, NPC animations, original OST and fine art fidelity remain open.
