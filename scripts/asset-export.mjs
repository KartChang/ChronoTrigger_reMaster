...
export async function exportAssets(root=process.cwd()){
  ...
  const modules={};
  for(const name of ['pixel-art','hero-art','world-art','fair-paving','rescue-art','prologue-art','trial-art','material-art','art-profile','hd-hero-art','witness-art']){
  ...
  const sources=['src/early-art.ts','src/surface-layout.ts','src/pixel-art.ts','src/hero-art.ts','src/world-art.ts','src/fair-paving.ts','src/rescue-art.ts','src/prologue-art.ts','src/prologue-data.ts','src/trial-art.ts','src/trial-render.ts','src/trial-data.ts','src/art-profile.ts','src/material-art.ts','src/material-runtime.ts','src/hd-hero-art.ts','src/witness-art.ts','src/actor-motion.ts','src/npc-motion.ts','src/pixel-presentation.ts'];const hash=createHash('sha256');
