...
export async function exportAssets(root=process.cwd()){
  ...
  const modules={};
  for(const name of ['imp-motion','canyon-canopy-art','canyon-art','woodland-art','pixel-art','hero-art','world-art','fair-paving','rescue-art','prologue-art','trial-art','trial-scenery-art','material-art','art-profile','hd-hero-art','witness-art']){
