...
await writeFile('dist/build-meta.json',JSON.stringify({version:'0.9.14',sourceSha:process.env.GITHUB_SHA??null,bundled:true,externalRequests:0,bytes:Buffer.byteLength(template)},null,2));
