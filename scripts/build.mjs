...
const buildInfo={version:'0.9.35',batch:'VQ02M',sourceSha:process.env.GITHUB_SHA??null};
...
await writeFile('dist/build-meta.json',JSON.stringify({...buildInfo,bundled:true,externalRequests:0,bytes:Buffer.byteLength(template)},null,2));
