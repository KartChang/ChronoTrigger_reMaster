...
await writeFile('dist/build-meta.json',JSON.stringify({version:'0.2.0',sourceSha:process.env.GITHUB_SHA??null,bundled:true,externalRequests:0,bytes:Buffer.byteLength(template)},null,2));
