...
export function canyonLIfDeclared(name,source){const edits=canyonLSpec.files[name];return edits?.some(e=>source.includes(e.after))?canyonLBaseline(name,source):source;}
