import {audioGIfDeclared} from './audio-g-baseline.mjs';
...
export function fairTrialBaseline(name,source){
 source=audioGIfDeclared(name,source);
...
export function fairTrialIfDeclared(name,source){source=audioGIfDeclared(name,source);const edits=spec.files[name];return edits?.some(e=>source.includes(e.after))?fairTrialBaseline(name,source):source;}
