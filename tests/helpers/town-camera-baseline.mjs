...
export const townCameraIfDeclared=(name,source)=>{source=npcComfortIfDeclared(name,source);return Object.hasOwn(spec.files,name)?townCameraBaseline(name,source):signOcclusionIfDeclared(name,source);};
