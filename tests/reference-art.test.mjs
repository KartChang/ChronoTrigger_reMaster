...
test('scene reset clears pending animation without leaking previous-world pose',()=>{const p=new PosePlayer();p.trigger('down',3);p.reset();assert.deepEqual(p.sample(3,false),{pose:'idle',frame:0});});
